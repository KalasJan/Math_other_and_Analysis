# Computational Mathematics & Core Algorithms (Python)
...
- **SciPy** – For advanced calculus and high-precision multi-variable numerical integration.
- **Matplotlib** – For interactive 3D surface plot renderings and view configuration mapping (`view_init`).

*Note: File names and inline comments are in Czech for internal logic documentation and reference. Only the 'Double_integral.py' framework is fully documented in English.*
